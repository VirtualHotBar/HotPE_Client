                    ...
                    : <>
                        ...
                        {!isUninstalling
                            ? <div style={{ textAlign: "center", marginTop: "100px" }}>
                                ...
                                {//更新按钮
                                    config.state.setupToSys < config.resources.pe.current?.id! ? <Button onClick={() => { updatePEForSys(setIsUninstalling, setCurrentStep, setStepStr,props.setLockMuen) }} type='primary' style={{ marginRight: 8 }}>更新</Button> : <></>}
